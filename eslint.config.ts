  ...
  eslintPluginUnicorn.configs.recommended,
  {
    rules: {
      "unicorn/prevent-abbreviations": [
        "error",
        {
          // Structural seam types use spec-mandated names (SpawnFn, DevHandle, TauriConfFragment) —
          // turn off the fn/dev/conf substring replacements so those compound names pass.
          replacements: {
            fn: false,
            dev: false,
            conf: false
